...
public class BlackjackClient {
    ...
    private static final String USERNAME = "npham"; // replace with your username
    private static final String PASSWORD = "7645dbd"; // replace with your from the file posted to Classroom
